...
(
  ...
  FOREIGN KEY (airlines_id) REFERENCES airline_name(airlines_id),
...
(
  ...
  FOREIGN KEY (airlines_id) REFERENCES airline_name(airlines_id),
  FOREIGN KEY (location_id) REFERENCES departed_from(loaction_id),
  FOREIGN KEY (location_id) REFERENCES arrival_too(loaction_id)
);
